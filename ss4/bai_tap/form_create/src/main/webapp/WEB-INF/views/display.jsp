...
<div class="container">
    ...
    <center><p style="color: red">Khuyến cáo: Khai báo thông tin sai là vi phạm pháp luật Việt Nam và có thể sử lý hình
        sự</p></center>
    <form:form modelAttribute="medical" action="/result" method="post" class="row">
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <span class="text-danger">(*)</span>
            <div class="form-check form-check-inline" style="margin: 15px">
